...
import com.blackhillsoftware.smf.smf98.ims.AggregateCpu;
import com.blackhillsoftware.smf2json.cli.Smf2JsonCLI;

/**
 * Format the Aggregate CPU times by CPU category from 
 * SMF 98 subtype 1025 (IMS) records
 * <p>
 ...
 *
 */
public class AggregateCpuSections 
{
    public static void main(String[] args) throws IOException                                   
    {
        Smf2JsonCLI cli = Smf2JsonCLI.create()
                .includeRecords(98, 1025)
                .description("Format SMF 98 IMS Aggregate CPU Section");
    ...
    private static class CliClient implements Smf2JsonCLI.Client
    {
        ...
        public List<Object> processRecord(SmfRecord record)
        {
            ...
            for (AggregateCpu aggregateCpu : r98.aggregateCpu())
            {     
